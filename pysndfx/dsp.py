...
class AudioEffectsChain:
    ...
    def delay(self, gain_in=0.8, gain_out=0.5, delays=((1000, 1800), ), decays=((0.3, 0.25), ), parallel=False):
    ...
    def phaser(self, gain_in=0.9, gain_out=0.8, delay=1, decay=0.25, speed=2, triangular=False):
    ...
    def tempo(self, factor, use_tree=False, opt_flag=None, segment=82, search=14.68, overlap=12):
